...
class ApolloV4BasePocContinuationStrategyTest {

    @Test
    void entersOnlyAfterReclaimHigherLowAndBreakOfInterveningHigh() {
        ApolloV4BasePocContinuationStrategy strategy = new ApolloV4BasePocContinuationStrategy(
                new ApolloV4BasePocContinuationStrategy.Config(14, 20, 12, 48,
