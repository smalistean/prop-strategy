...
--
-- Superseded Codex artifact. It now writes the provisional CSV pair under this study's generated/
-- directory; see the parent README for why this export is not decision-grade.
--
...
\copy (SELECT d w, base, sv, sv_sym, lv, lv_sym, pair_type, disc_spread spread FROM ranked ORDER BY d, rk) TO '/Users/stas/workspace/other/prop-strategy/CODEX_ARTIFACTS/XVF_TWO_YEAR_REPLAY_2026-08-21/generated/candidates_full.csv' WITH CSV HEADER
\copy (SELECT venue, sym venue_symbol, d, rate rate_sum FROM daily) TO '/Users/stas/workspace/other/prop-strategy/CODEX_ARTIFACTS/XVF_TWO_YEAR_REPLAY_2026-08-21/generated/funding_daily_fresh.csv' WITH CSV HEADER
